...
{{< img-optimized src="ackchyually.png" alt="Ackchyually" >}}
...
Before theme color
{{< img-optimized src="before-theme-color.png" alt="before-theme-color" >}}

After theme color addition on `<head>`
{{< img-optimized src="after-theme-color.png" alt="after-theme-color" >}}

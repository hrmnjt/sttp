+++
title = "introducing requests for discussion"
slug = "rfd"
date = 2026-02-08
+++

I'm a RFD fanboy! I love reading them, and I wish for a workplace which follows
them. I explain any concept 9.3x better if I write it before hand. At work, I
always find opportunity for "applied ideas" and writing specifics makes it
concrete and relevant given known implicit constraints.
...
great! RFD as a medium is productive for me and in absence of an existing
culture, I try and push to use RFDs (or equivalent) to share technical
improvements (features or tech-debt).

Finally, I'm a huge proponent of [Boring Tech Club][1] and I seldom propose new
technical concepts at work. Having RFDs as an enforced approach cuts half of the
random water-cooler suggestion like hot knife on butter. A log of RFDs can
quickly show (in metrics) the innovation tokens spent by team and prevent team
from chasing shiny new tech (which is seldom an answer to any problem).

Following is a sanitized `001-rfd-template` that I submitted to my monorepo/docs
folder seeking comments and commitment from team. This is a reference for myself
but if this inspired you to try RFDs, you can adopt below or choose from amazing
content that on internet (keyword: ADR/RFD). Thanks for coming to my Ted Talk!

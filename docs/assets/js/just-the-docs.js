(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://hrmnjt.github.io/sttp/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://hrmnjt.github.io/sttp/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://hrmnjt.github.io/sttp/assets/css/just-the-docs-' + theme + ".css"
      );
    };
